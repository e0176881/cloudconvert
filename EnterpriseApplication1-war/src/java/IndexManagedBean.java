      ...
      //  StringEntity entity = new StringEntity(payload,
       ...
       // request.setEntity(entity);
        ...
        try (CloseableHttpClient httpclient = HttpClients.custom().setRedirectStrategy(new LaxRedirectStrategy()).build()) {
            ...
            File file = new File("/Users/mingxuan/Desktop/lame.pdf");
            ...
            String  newResponseBody = httpclient.execute(newRequest, responseHandler);
            System.out.println("----------------------------------------");
       ...
       // request.setEntity(entity);
        ...
        System.out.println(responseBody3);
         ...
         JSONObject vcxvcxvxc = new JSONObject(responseBody);
